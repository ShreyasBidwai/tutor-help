...
def dashboard():
    ...
    return render_template('admin/dashboard.html',
        ...
        total_batches=total_batches, today_attendance=today_attendance,
        active_teachers=active_teachers, new_signups=new_signups,
        recent_teachers=recent_teachers, today=today)
